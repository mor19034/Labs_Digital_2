...
# 8 "configuraciones_pic.c" 2

# 1 "./configuraciones_pic.h" 1
# 34 "./configuraciones_pic.h"
...
void nibbles (uint8_t dato){
    down_nibbles = dato&0x0F;
    upper_nibbles = (dato>>4)&0x0F;
}
